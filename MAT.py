...
def menu_apikey():
  ...
  print(f"""\x1b[1;97m
    ...
    ¦ [?] VERSION  : 0.0                    ¦
    ¦ [?] POWER BY : \033[1;32mNOOB AKiL \033[1;37m            ¦
    +---------------------------------------+""")                                           
def Spy():
	clear()
	#ckx()
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AKIL=session.cookies.get_dict().keys()
                        if "c_user" in AKIL:
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  AKIL, Sabbir, Forhad ')
                code = input(' First name : ')
                print(' Name Example : AKIL, hossen, hossain')
